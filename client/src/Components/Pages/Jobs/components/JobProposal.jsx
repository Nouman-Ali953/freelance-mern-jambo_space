    ...
    const submit = () => {
        ...
        if (cover.length === 0 || cover === undefined) {
            ...
            const formData = {
                ...
                sellerID: user._id,
                amount,
                costumerID: selectedJob.customerID,
                jobID: selectedJob._id,
                milestones: bidType !== "byProject" ? milestones : false,
                status: "send"
            }

            const string = JSON.stringify(milestones)
            ...
            form.append("milestones", bidType !== "byProject" ? string : false)
